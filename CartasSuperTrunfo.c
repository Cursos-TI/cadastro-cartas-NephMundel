...
int main() {
   ...
   int indice = 0; // variavel para Contar as posiçoes dos arrays e adicionar e salvar
   ...
   struct cartas { //variaveis usando o comando struct que serve pra juntar as informaçoes ao invez de separa-las
    ...
    struct cartas carta[32];// um array contendo 32 cartas para inserir informaçoes de cidades
